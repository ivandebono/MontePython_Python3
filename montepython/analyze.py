                ...
                if conf.plot:
                    ...
                    if (info.custom1d != []):
                        for elem in info.custom1d:
                            exec(compile(open('plot_files/'+elem, "rb").read(), 'plot_files/'+elem, 'exec'))
...
class Information(object):
    ...
    def __init__(self, command_line, other=None):
        ...
        if command_line.optional_plot_file:
            ...
            exec(compile(open(command_line.optional_plot_file, "rb").read(), command_line.optional_plot_file, 'exec'), plot_file_vars)
