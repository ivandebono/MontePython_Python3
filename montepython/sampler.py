...
def compute_lkl(cosmo, data):
    ...
    for likelihood in six.itervalues(data.lkl):
    ...
    if data.get_mcmc_parameters(['derived']) != []:
        try:
            ...
            for name, value in six.iteritems(derived):
